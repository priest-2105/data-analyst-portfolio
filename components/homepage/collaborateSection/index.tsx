    ...
    <section className="py-24 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 relative">
          <h2 className="mt-4 max-w-2xl mx-auto text-4xl md:text-3xl lg:text-4xl font-semibold leading-tight text-transparent bg-clip-text bg-custom-gradient">
        ...
        <div className="-right-0 w-fit mr-auto ml-auto mt-4 rotate-180 bottom-0 bg-white rounded-full px-4 py-2 shadow-md  animate-updown">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {services.map((service, index) => (
            ...
            >
              <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gray-100 group-hover:bg-gray-50 transition-colors">
